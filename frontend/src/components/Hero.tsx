...
export default function Hero(): JSX.Element {
  return (
    <section className="rounded-3xl bg-gradient-to-r from-blue-600 via-indigo-600 to-violet-600 px-6 py-14 text-white">
      ...
      <Link to="/events" className="mt-6 inline-block rounded bg-white px-5 py-2 font-medium text-brand-600">Explorer les événements</Link>
    </section>
  );
}
